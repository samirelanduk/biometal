...
The `GitHub issue
tracker <https://github.com/samirelanduk/biometal/issues>`__ is the place
...
The first step is to fork the biometal repository to your own GitHub
...
clone your new copy of biometal to your local machine, and to do this
you simply enter ``clone https://github.com/YOUR_USERNAME/biometal`` at
...
An ideal pull request for biometal is one that either adds a function (or
...
If your pull request modifies large parts of biometal, changes the way the
...
If a function doesn't have tests, the function doesn't work. biometal has
